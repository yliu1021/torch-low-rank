...
def get_lr_model(input_shape: List[int], num_classes: int, initial_ranks: List[int] = None):
    """ 
...
def get_lr_vgg16(input_shape: List[int], num_classes: int, initial_ranks: List[int] = None):
    """ 
...
def get_lr_vgg11(input_shape: List[int], num_classes: int, initial_ranks: List[int] = None):
    """ 
